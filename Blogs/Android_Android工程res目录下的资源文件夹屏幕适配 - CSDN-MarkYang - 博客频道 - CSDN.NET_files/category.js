	...
	$.get(url, function (res) {
	    ...
	    if (type == "top")
	    {
	        ...
	        if (parseInt(count) > 5)
	        {
	            ...
	            objtop.append("<li style=\"padding-left: 300px;\"><a href='" + moreurl + "'>更多</a></li>");
	        }
	    ...
	    {	       	       
	        ...
	        $.each(res, function (i) {	            
	            ...
	            if (aid != obj.articleid) {
	                ...
	                var html = "<li><em>•</em><a href='" + articleurl + "'  id='" + aritcleid + "'></a></li> ";
	                if (j % 2 == 1) {
	        ...
	        if (parseInt(count) > 10) {
	            ...
	            if (moreurl != "") {
	                objfootright.append("<li style=\"padding-left: 200px;\"><a href='" + moreurl + "'>更多</a></li>");
	            }
	        }
	    }
	});
