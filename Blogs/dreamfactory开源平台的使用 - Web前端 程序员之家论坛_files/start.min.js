(function() {
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/start.js", function(require, exports, module) {
        var $ = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/lib/jquery-1.7.0.js"), _ = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/lib/underscore-1.8.2.js"), $$util = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/util/util.js");
        var fnInitDom = function() {
        ...
        var fnStart = function(config, feConfig, beConfig, cookie) {
            ...
            var $$confWhiteList = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/config-white-list.js");
            ...
            fnLoad(function() {
                $$util.loadJs($$data.get("config:base") + "mdevp/extensions/icp-tips/006/icp-tips.js", function() {
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/config-white-list.js", function(require, exports, module) {
        ...
        var wlist = {
            fbeWhiteList: [ "extensions", "simple_cbox", "footer_fix_cbox", "latest_page_num", "hot_page_num", "custom_css_type" ],
            feWhiteList: [ "appid", "url", "title", "sid", "category_id", "show_score", "jump_url" ],
            beWhiteList: [ "comment_notice", "copyright", "cyan_title", "domain_whitelist", "hot_topic_list", "hot_topic_mode", "show_participation", "login_external_platform", "allow_upload_img", "comment_operation", "use_user_level", "v3_hack", "display_location", "disable_user_photo", "user_portrait_url", "extensions_key", "sso", "sso_button_action", "sso_button_action_type", "sso_isv_login", "sso_isv_logout", "sso_isv_userInfo", "sso_login_logo", "sso_type", "is_new_cdn", "isv_type" ]
        };
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/api/api.js", function(require, exports, module) {
        ...
        var fnInitApi = function() {
            ...
            api = _.extend(api, require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/api/wechat-operate.js"));
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/api/user.js", function(require, exports, module) {
        ...
        var userApi = {
            ...
            login: function(platformId, mobile, pwd) {
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/api/events.js", function(require, exports, module) {
        ...
        var eventApi = {
            ...
            register: function(namespace, key) {
                var extensionsWhiteList = [ "changyan", "cmt-header", "cmt-list", "cmt-box", "cmt-float-bar", "cmt-footer", "cy-user-page", "cy-user-info" ];
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/api/async-load-extension.js", function(require, exports, module) {
        ...
        var asyncApi = {
            ...
            LoginMode: function(tag) {
                var that = this;
                if ($$data.get("beConfig:sso_type") === "2") {
                    if ($$data.get("beConfig:sso") === "true" && $$data.get("beConfig:sso_button_action_type") === "1") {
                        that.doWinLogin($$data.get("beConfig:sso_button_action"));
                    } else if ($$data.get("beConfig:sso") === "true" && $$data.get("beConfig:sso_button_action_type") === "2") {
                        that.ssoLoginfn($$data.get("beConfig:sso_button_action"));
                    } else {
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/api/sso/sso-init.js", function(require, exports, module) {
        ...
        var fnGetIsvUserInfo = function(data, fn) {
            if (data.is_login) {
                ...
                $$login.logout();
                if ($$data.get("userInfo:sso") && $$data.get("userInfo:sso:is_login")) {
                    logoutIsv();
                }
                fn({
                    error_code: 10207,
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/api/wechat-operate.js", function(require, exports, module) {
        var $ = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/lib/jquery-1.7.0.js");
        _ = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/lib/underscore-1.8.2.js"), $$data = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/util/data-center.js"), $$util = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/util/util.js");
        var wechatObj = {
            wechatBind: {},
            wechatOpen: function() {
                var that = this;
                if (window.changyan.wechatOperate) {
                    that.wechatBind.inPageBind = window.changyan.wechatOperate.inPageBind;
                    that.wechatBind.outPageBind = window.changyan.wechatOperate.outPageBind;
                } else {
                    $$util.loadJs($$data.get("config:base") + "mdevp/extensions/wechat-bind/009/wechat-bind.js", function() {
                        that.wechatBind.inPageBind = window.changyan.wechatOperate.inPageBind;
                        that.wechatBind.outPageBind = window.changyan.wechatOperate.outPageBind;
                    });
                }
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3