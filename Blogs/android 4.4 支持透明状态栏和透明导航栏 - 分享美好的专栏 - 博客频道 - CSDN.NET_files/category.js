...
$(function()
{
        ...
        aCategory.click(function () {
            if ($(this).find(".subItem").is(":hidden")) {
                //close all
                var thisClickText = $(this).attr("onclick").toString()

                $.each(aCategory, function (i) {
                    var thisCategory = $(aCategory[i]);
                    var thisCategoryText=thisCategory.attr("onclick").toString()
	    ...
	    if (type == "top")
	    {
	        ...
	        $(res).each(function (i) {
	            ...
	            if (aid != obj.articleid) {	             
	                ...
	                objtop.append("<li><em>•</em><a class=\"tracking-ad\" data-mod=\"popu_140\" href='" + articleurl + "'  id='" + aritcleid + "'></a></li> ");
	    ...
	    {	       	       
	        ...
	        $.each(res, function (i) {	            
	            ...
	            if (aid != obj.articleid) {
	                ...
	                var html = "<li><em>•</em><a class=\"tracking-ad\" data-mod=\"popu_141\" href='" + articleurl + "'  id='" + aritcleid + "'></a></li> ";
	                if (j % 2 == 1) {
